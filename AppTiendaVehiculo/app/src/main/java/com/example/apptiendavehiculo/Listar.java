...
public class Listar extends AppCompatActivity {
    ...
    final String URL = "http://192.168.1.10:3000/vehiculos";
    ...
    private void getData(){
        //1. Habilitar un canal de comnicacion
        requestQueue = Volley.newRequestQueue(this);

        //2. Preparar datos del servidor ¿Que datos enviara el servicio? Rpta: Arreglo Json
